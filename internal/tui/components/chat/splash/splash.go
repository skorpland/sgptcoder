...
import (
	...
	"github.com/skorpland/sgptcoder/internal/llm/prompt"
	...
	"github.com/skorpland/sgptcoder/internal/tui/exp/list"
...
func (s *splashCmp) View() string {
	...
	if s.needsAPIKey {
		...
		initText := lipgloss.JoinVertical(
			...
			bodyStyle.Render("result into a SGPT.md file which serves as general context."),
			"",
