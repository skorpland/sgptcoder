...
// It uses hierarchical ignore checking like git does, checking .gitignore/.sgptignore
...
// sgptignore, and hidden file rules
...
// respecting hierarchical .gitignore/.sgptignore files like git does.
