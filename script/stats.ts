...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/skorpland/sgptcoder/releases?page=${page}&per_page=${per}`
...
console.log("Fetching npm all-time downloads for sgptcoder-ai...\n")
const npmDownloads = await fetchNpmDownloads("sgptcoder-ai")
