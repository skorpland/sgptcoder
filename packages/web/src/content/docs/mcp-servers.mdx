...
You can add external tools to sgptcoder using the _Model Context Protocol_, or MCP. sgptcoder supports both:
...
You can define MCP servers in your sgptcoder config under `mcp`.
...
```json title="sgptcoder.json" {11, 14-17}
{
  "$schema": "https://sgptcoder.ai/config.json",
  "mcp": {
    "my-mcp": {
