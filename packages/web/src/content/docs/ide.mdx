---
title: IDE
description: The sgptcoder extension for VS Code, Cursor, and other IDEs
---

sgptcoder integrates with VS Code, Cursor, or any IDE that supports a terminal. Just run `sgptcoder` in the terminal to get started.
...
To install sgptcoder on VS Code and popular forks like Cursor, Windsurf, VSCodium:

1. Open VS Code
2. Open the integrated terminal
3. Run `sgptcoder` - the extension installs automatically

---

### Manual Install

Search for **sgptcoder** in the Extension Marketplace and click **Install**.
...
- Ensure you’re running `sgptcoder` in the integrated terminal.
