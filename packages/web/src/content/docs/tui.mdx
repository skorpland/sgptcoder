---
title: TUI
description: Using the sgptcoder terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

sgptcoder provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running sgptcoder starts the TUI for the current directory.
...
When using the sgptcoder TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Exit sgptcoder. _Aliases_: `/quit`, `/q`
