...
sgptcoder has a list of keybinds that you can customize through the sgptcoder config.
...
sgptcoder uses a `leader` key for most keybinds. This avoids conflicts in your terminal.
