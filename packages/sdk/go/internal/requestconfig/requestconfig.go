...
import (
	...
	"github.com/skorpland/sgptcoder-sdk-go/internal/apierror"
	"github.com/skorpland/sgptcoder-sdk-go/internal/apiform"
...
func getDefaultHeaders() map[string]string {
	return map[string]string{
		"User-Agent": fmt.Sprintf("Sgptcoder/Go %s", internal.PackageVersion),
	}
}
